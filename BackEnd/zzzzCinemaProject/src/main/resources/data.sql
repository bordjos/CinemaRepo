...
--FILMS
INSERT INTO film(id, name, director, cast, length, distributor, country, year, about) VALUES (1, "Pulp Fiction", "Quentin Tarantino", "John Travolta, Uma Thurman, Samuel L. Jackson", 154, "Miramax", "United States", 1994, "The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.");
INSERT INTO film(id, name, director, cast, length, distributor, country, year, about) VALUES (2, "Reservoir Dogs", "Quentin Tarantino", "Harvey Keitel, Tim Roth, Michael Madsen", 99, "Miramax", "United States", 1992, "When a simple jewelry heist goes horribly wrong, the surviving criminals begin to suspect that one of them is a police informant.");
INSERT INTO film(id, name, director, cast, length, distributor, country, year, about) VALUES (3, "Forrest Gump", "Robert Zemeckis", "Tom Hanks, Robin Wright, Gary Sinise", 144, "Paramount Pictures", "United States", 1994, "The history of the United States from the 1950s to the '70s unfolds from the perspective of an Alabama man with an IQ of 75, who yearns to be reunited with his childhood sweetheart.");
INSERT INTO film(id, name, director, cast, length, distributor, country, year, about) VALUES (4, "The Godfather", "Francis Ford Coppola", "Marlon Brando, Al Pacino, James Caan", 175, "Paramount Pictures", "United States", 1972, "Don Vito Corleone, head of a mafia family, decides to hand over his empire to his youngest son Michael. However, his decision unintentionally puts the lives of his loved ones in grave danger.");
INSERT INTO film(id, name, director, cast, length, distributor, country, year, about) VALUES (5, "The Lord of the Rings: The Return of the King", "Peter Jackson", "Elijah Wood, Viggo Mortensen, Ian McKellen", 201, "New Line Cinema", "United States", 2003, "Gandalf and Aragorn lead the World of Men against Sauron's army to draw his gaze from Frodo and Sam as they approach Mount Doom with the One Ring.");
